                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('danhmuc.store')}}" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{(old('tendanhmuc'))}}" name="tendanhmuc" id="slug" aria-describedby="emailHelp" 
                            placeholder="Tên danh mục..." onkeyup="ChangeToSlug();">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1" class="form-label">Slug danh mục </label>
                            <input type="text" class="form-control" value="{{(old('slug_danhmuc'))}}" name="slug_danhmuc" id="convert_slug" aria-describedby="emailHelp" 
